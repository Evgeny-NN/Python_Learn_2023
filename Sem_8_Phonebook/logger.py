...
def add_person():
    ...
    data = open('C:\\Users\\Евгений\\Desktop\\Python_HomeWork\\HomeWork_8\\Phonebook.txt',
                'a', encoding='utf-8')
...
def print_data():
    with open('C:\\Users\\Евгений\\Desktop\\Python_HomeWork\\HomeWork_8\\Phonebook.txt', 'r', encoding='utf-8') as data:
        print(data.read())
